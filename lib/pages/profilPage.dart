        ...
        body: Column(
          children: [
            ...
            Container(
              width: h / 2.1,
              decoration:
                  BoxDecoration(borderRadius: BorderRadius.circular(h / 42.2)),
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: const Text(
                              '''     Annagylyç Esenow edebi döredijilige 1968-nji ýylda  ilkinji makala we goşgulary gazetlerde çap edilip başlandan soň, yzygiderli girişip ýyllardyr. Soň 1990-2010ý. aralygynda dürli sebäplere görä goşgy, başlady. Goşgy düzüliş tehnikasyny, edebiýat teoriýasyny tiz ele aldy.
      Proza, makala, terjimeler bilen hem meşgullanyp başlady. Şeýle materiallary “Zähmetkeşler sesi”, “Zähmet baýdagy” (“Balkan”) we merkezi gazet-žurnallarda barha yzygiderli çap edildi. Ýaş ýazyjylaryň 
oblast we respublikan seminarlarynda A.Esenowyň döredijiliginiň barha kämilleşýändigi nygtaldy. Dürli ýyllarda Türmenistanyň halk ýazyjylary Ç. Aşyrow, A. Kowusow, K. Gurbannepesow, Ý. Durdyýew, A.Atabaýew, I. Nuryýew, professor şahyr  G. Geldiýew we başgalar
...
ýazaweri!” diýen adamlaryň onlarçasynyň sözleri heniz hem ýadymda dur!
     Şu uzak onýyllyklaryň dowamynda meniň döredijiligimi goldan adamlar hem, çap etmekden galdyran adamlar hem bolupdy.
   “Uly ýola niýetlenen gämiler\n   Her öwsen şemala çaýkanýan däldir” — diýen setirlerim şeýle pursatlarda döräpdi.
     ...
     Söz üçin, setir üçin ukusyz geçen gijelerime, öz-özüme gümra bolup çola çykan pursatlaryma, köp gezek ýaşlyk eşretlerinden özümi mahrum edenime sähelçe-de ökünemok.''',
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                bottom: 15, left: h / 42.2, right: h / 42.2),
                            child: const Text(
                              ''' “Ömür menzili” atly mobil programma görnüşindäki elektron kitaby Annagylyç Esenowyň ömür döredijiligine bagyşlanýar.''',
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                fontStyle: FontStyle.italic,
